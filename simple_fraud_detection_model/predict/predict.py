...
model = ml.load_random_forest_model('../models/random_forest.p')
...
def log_results(results):
    ...
    # this could be expanded to log predictions to s3 or DynamoDB or back to MongoDB, whereever makes sense.


def poll_mongo(frequency_s=60):

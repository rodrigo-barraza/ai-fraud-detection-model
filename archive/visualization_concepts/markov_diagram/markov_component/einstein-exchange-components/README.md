# einstein-exchange-components

Custom plotly dash components for Einstein Exchange
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> einstein-exchange-components -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import einstein-exchange-components to your layout, then run it:
